...
def qa_flowrateaudit(
    ...
    data for Alabama in January 2018::
        ...
        ...
        aqs.bystate.qa_flowrateaudit(
            parameter="88101", bdate=date(year=2018, month=1, day=1), edate=date(year=2018, month=1, day=31), stateFIPS="01"
        )
...
def qa_one_point_qc(
    ...
    data for ozone in Massachusetts in January 2018::
        ...
        ...
        aqs.bystate.qa_one_point_qc(
            parameter="44201", bdate=date(year=2018, month=1, day=1), edate=date(year=2018, month=1, day=31), stateFIPS="25"
        )
...
def qa_pep_audit(
    ...
    Return a DataFrame of PEP audit data for PM2.5 in Alabama 2017::
        ...
        ...
        aqs.bystate.qa_pep_audit(
            parameter="88101", bdate=date(year=2017, month=1, day=1), edate=date(year=2017, month=12, day=31), stateFIPS="01"
        )
...
def sampledata(
    ...
    North Carolina collected from May 15th, 1995 - May 15, 1999::
        ...
        ...
        aqs.bystate.sampledata(
            parameter="45201", bdate=date(year=1995, month=5, day=15), edate=date(year=1995, month=5, day=15), stateFIPS="37"
        )
...
def annualsummary(
    ...
    North Carolina collected from May 15th, 1995 - May 15, 1999::
        ...
        ...
        aqs.bystate.annualsummary(
            parameter="45201", bdate=date(year=1995, month=5, day=15), edate=date(year=1999, month=5, day=15), stateFIPS="37"
        )
...
def qa_collocated_assessments(
    ...
    assessment data for FRM2.5 for January 2013::
        ...
        ...
        aqs.bystate.qa_collocated_assessments(
            parameter="88101", bdate=date(year=2013, month=1, day=1), edate=date(year=2013, month=1, day=31), stateFIPS="01"
        )
...
def qa_flowrateverification(
    ...
    Alabama for 2017-2019::
        ...
        ...
        aqs.bystate.qa_flowrateverification(
            parameter="88101", bdate=date(year=2017, month=1, day=1), edate=date(year=2019, month=12, day=31), stateFIPS="01"
        )
...
def qa_annualperformanceeval(
    ...
    data for ozone in Alabama for 2017::
        ...
        ...
        aqs.bystate.qa_annualperformanceeval(
            parameter="44201", bdate=date(year=2017, month=1, day=1), edate=date(year=2017, month=12, day=31), stateFIPS="01"
        )
...
def qa_annualperformanceevaltransaction(
    ...
    for ozone in Alabama for 2017 in RD format.::
        ...
        ...
        aqs.bystate.qa_annualperformanceevaltransaction(
            parameter="44201", bdate=date(year=2017, month=1, day=1), edate=date(year=2017, month=12, day=31), stateFIPS="01"
        )
...
def quarterlysummary(
    ...
    FRM/FEM PM2.5 data for North Carolina for each quarter of  2016-2017::
        ...
        ...
        aqs.bystate.quarterlysummary(
            parameter="88101", bdate=date(year=2016, month=1, day=1), edate=date(year=2017, month=12, day=31), stateFIPS="37"
        )
