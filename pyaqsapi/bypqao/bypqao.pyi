...
def qa_collocated_assessments(
    ...
    Department of Environmental Management (agency 0013)::
        ...
        ...
        aqs.bypqao.qa_collocated_assessments(
            parameter="88101", bdate=date(year=2013, moth=1, day=1), edate=date(year=2013, month=1, day=31), pqao_code="0013"
        )
...
def qa_flowrateverification(
    ...
    Department of Environmental Management (agency 0013)::
        ...
        ...
        aqs.bypqao.aqs_qa_flowrateverification(
            parameter="88101",
            bdate=date(year=2018, month=1, day=1),
            edate=date(year=2018, month=1, day=31),
            pqao_code="0013",
...
def qa_annualperformanceeval(
    ...
    Environmental Management (pqao_code 0013).::
        ...
        ...
        aqs.bypqao.qa_annualperformanceeval(
            parameter="44201",
...
def qa_annualperformanceevaltransaction(
    ...
    Environmental Management (pqao_code 0013) for 2017 in RD format.::
        ...
        ...
        aqs.bypqao.qa_annualperformanceevaltransaction(
            parameter="44201",
            bdate=date(year=2017, month=1, day=1),
            edate=date(year=2017, month=12, day=31),
            pqao_code="0013",
